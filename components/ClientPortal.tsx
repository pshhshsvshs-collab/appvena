                        ...
                        <div className="max-w-4xl mx-auto bg-white p-4 sm:p-6 lg:p-8 xl:p-12 shadow-lg">
                            <header className="flex flex-col sm:flex-row justify-between items-start mb-8 sm:mb-12 space-y-4 sm:space-y-0">
                                <div className="w-full sm:w-auto">
                                    <h1 className="text-2xl sm:text-3xl font-extrabold text-slate-900">{profile.companyName}</h1>
                                    <p className="text-xs sm:text-sm text-slate-500">{profile.address}</p>
                                    <p className="text-xs sm:text-sm text-slate-500">{profile.phone} | {profile.email}</p>
                                </div>
                            ...
                            <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-8 sm:mb-12">
                                <div className="bg-slate-50 p-4 sm:p-6 rounded-xl">
                                    ...
                                    <p className="text-xs sm:text-sm text-slate-600">{client.email}</p>
                                    <p className="text-xs sm:text-sm text-slate-600">{client.phone}</p>
                                </div>
                                <div className="bg-slate-50 p-4 sm:p-6 rounded-xl">
                                    <h3 className="text-xs font-semibold uppercase text-slate-400 mb-2">Diterbitkan Oleh</h3>
                                    <p className="font-bold text-slate-800">{profile.companyName}</p>
                                    <p className="text-xs sm:text-sm text-slate-600">{profile.email}</p>
                                    <p className="text-xs sm:text-sm text-slate-600">{profile.phone}</p>
                                </div>
