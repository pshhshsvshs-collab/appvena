...
const Header: React.FC<HeaderProps> = ({ pageTitle, toggleSidebar, setIsSearchOpen, notifications, handleNavigation, handleMarkAllAsRead, currentUser, profile }) => {
        ...
        <div className="flex-shrink-0">
            ...
            >
                ...
                <div className="flex items-center min-w-0 flex-1">
                    ...
                    <div className="lg:hidden flex items-center gap-3 ml-2 min-w-0 flex-1">
                        {/* User Avatar */}
                        <div className="
                            ...
                            shadow-sm
                        ">
                            <UsersIcon className="w-4 h-4 sm:w-5 sm:h-5 text-brand-accent" />
                        </div>
